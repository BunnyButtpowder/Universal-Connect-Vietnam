                ...
                <div className="p-3">
                    <div className="relative h-full w-full overflow-hidden rounded-xl">
                        <img
                            src={tour.imageUrl}
                            alt="Tour image"
                            className="w-full h-full object-cover transition-transform duration-300 group-hover/card:scale-110 other-tour-image"
                            onError={(e) => {
            ...
            <div className="px-6 mb-5 mt-2 space-y-3">
                ...
                <div className="flex justify-between items-center pt-2">
                    ...
                    {tour.isComingSoon ? (
                        ...
                        <div className="flex items-center space-x-1 text-navy-800 other-tour-price">
    ...
    return (
        <div>
            ...
            <div className="mt-20">
                <div className="mx-4 lg:mx-0 md:mx-6 lg:px-20 overflow-hidden relative flex flex-col"
                    ...
                    <div className="absolute bottom-10 lg:ms-28 lg:me-48 tour-info-card-bg rounded-2xl px-4 lg:px-6 pb-4 lg:pb-6">
                        ...
                        <div className="flex flex-col lg:flex-row justify-between border-b border-blue-200/50 pb-3 lg:mx-3">
                            <h2 className="text-3xl lg:text-4xl font-medium text-content pb-3 tour-details-title">{tour.title}</h2>
                            <div className="flex flex-row gap-2 items-center tour-social-share">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-5 justify-between items-start gap-5 lg:gap-10 mt-6 lg:mx-3">
                            <div className="lg:col-span-3">
                                ...
                                {isPreRegisterTour ? (
                                    ...
                                    // Full Tour - Show sign up and customize options
                                    <div className="grid grid-cols-1 md:grid-cols-7 gap-2 md:gap-0">
                                        <div className="md:col-span-2 flex items-center">
                                        ...
                                        <div className="md:col-span-5 flex items-center gap-3 bg-orange-100 rounded-xl px-4 py-2 customize-section">
                ...
                <div className="md:px-6 lg:px-48 bg-blue-50 py-16 px-8 mt-20 lg:mt-0">
                ...
                <div className="mx-4 lg:mx-48 2xl:mx-48 my-10 grid grid-cols-1 lg:grid-cols-5 gap-10 lg:gap-20">
                    <div className="grid lg:col-span-2 grid-rows-6 lg:grid-rows-10">
                        ...
                        <div className="flex flex-col row-span-5 lg:row-span-7 justify-center">
                            {tour.eventTypes && tour.eventTypes.length > 0 ? (
                                ...
                                <div className="flex flex-col items-center justify-center py-8 px-4 text-center bg-blue-50 rounded-xl">
                                    <div className="mb-4">
                                    ...
                                    <p className="text-gray-600 text-sm max-w-xs">
                                        We're finalizing the exciting events for this tour. Stay tuned!
                                    </p>
                                </div>
                            )}
                        </div>
                        ...
                        <div className="relative rounded-3xl overflow-hidden flex flex-row lg:row-span-7">
                            {tour.additionalImages && tour.additionalImages.length > 0 ? (
                                <Carousel className="w-full" setApi={setApi} plugins={[Autoplay({ delay: 4000 })]}>
                                    ...
                                    <div className="absolute bottom-4 -right-5 transform -translate-x-1/2 lg:left-auto lg:translate-x-0 lg:right-4 px-4 py-2 font-medium text-lg items-center gap-2 flex">
                                        <div className="flex space-x-1 items-center">
                                            {Array.from({ length: tour.additionalImages.length }).map((_, i) => (
                                                <span
                                                    key={i}
                                ...
                                <div className="w-full flex flex-col items-center justify-center bg-blue-50 py-16 px-8 text-center rounded-3xl">
                                    {/* Image Icon */}
                                    <div className="mb-6">
                                        <svg className="w-16 h-16 text-blue-200" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    {/* Description */}
                                    <p className="text-gray-600 text-lg mb-6 max-w-md">
                                        We're preparing stunning visuals to showcase this experience. Check back soon!
                                    </p>
                            ...
                            <div className="location-carousel-container relative">
                                {tour.cities && tour.cities.length > 0 ? (
                                    ...
                                    >
                                        ...
                                        <div className="carousel-indicators flex justify-center mt-4">
                                            <div className="carousel-indicator-container flex space-x-2 items-center">
                                                {Array.from({ length: Math.min(tour.cities.length, count) }).map((_, i) => (
                                                    <span
                                                        key={i}
                                    ...
                                    <div className="flex flex-col items-center justify-center py-16 px-8 text-center">
                                        ...
                                        {/* Description */}
                                        <p className="text-gray-600 text-lg mb-6 max-w-md">
                                            We're selecting the best destinations for this tour. Check back soon for our itinerary!
                                        </p>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-4 gap-2">
                        ...
                        <div className="lg:col-span-2 flex flex-col space-y-6 overflow-hidden rounded-3xl tour-info-card-bg py-10 px-8">
                            ...
                            {tour.packageIncludes && tour.packageIncludes.length > 0 ? (
                                ...
                                <div className="flex flex-col items-center justify-center py-8 text-center">
                                    ...
                                    <p className="text-gray-600 text-sm max-w-xs">
                                        We're finalizing what's included in this amazing package!
                                    </p>
                                </div>
                            )}
                        </div>
                        ...
                        <div className="lg:col-span-2 h-full">
                            <div className="overflow-hidden rounded-3xl h-full">
                                {tour.additionalImages && tour.additionalImages.length > 1 ? (
                                    <img src={tour.additionalImages[1]} alt="Tour Package" className="w-full h-full object-cover" />
                                ) : (
                                    <div className="w-full h-full flex items-center justify-center bg-blue-50">
                                        <div className="text-center">
                                            <svg className="w-16 h-16 text-blue-200 mx-auto mb-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                                <path fillRule="evenodd" d="M4 3a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V5a2 2 0 00-2-2H4zm12 12H4l4-8 3 6 2-4 3 6z" clipRule="evenodd" />
                                            </svg>
